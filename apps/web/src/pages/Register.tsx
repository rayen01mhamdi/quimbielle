  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f4f6fb" }}>
      <div style={{ background: "#fff", border: "1px solid #dde2f0", borderRadius: 20, padding: "2.5rem", width: "100%", maxWidth: 380, boxShadow: "0 2px 16px rgba(91,94,244,0.06)" }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 800, margin: "0 0 6px", color: "#1a1f36" }}>Get started</h1>
        <p style={{ fontSize: 14, color: "#8892b0", margin: "0 0 2rem" }}>Create your Quimbielle account</p>
        ...
        <form onSubmit={handleSubmit}>
          <label style={{ fontSize: 13, fontWeight: 600, color: "#4a5580", display: "block", marginBottom: 6 }}>Full name</label>
          <input
            type="text"
            value={name}
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "#8892b0", margin: 0 }}>
          Already have an account? <Link to="/login" style={{ color: "#5b5ef4", fontWeight: 600, textDecoration: "none" }}>Sign in</Link>
        </p>
      </div>
    </div>
  )
